let key = "a61f8ff7db2054de0d3d545da44a271c"//"<<Replace it With your API Key>>" Don't have a key? Get it for free from openweathermap.org
var cityName = "";
var link = "";
var link_trend = "";
var link_time = "";
...
function parseJson2(cityName){
	...
	request1.onload = function(){
		...
		if (request1.status >= 200 && request1.status < 400) {
			...
			document.getElementById("temp1").innerHTML = obj.list[0].main.temp+"°C";
			document.getElementById("temp2").innerHTML = obj.list[1].main.temp+"°C";
			document.getElementById("temp3").innerHTML = obj.list[2].main.temp+"°C";
			document.getElementById("temp4").innerHTML = obj.list[3].main.temp+"°C";
			document.getElementById("temp5").innerHTML = obj.list[4].main.temp+"°C";
			document.getElementById("temp6").innerHTML = obj.list[5].main.temp+"°C";
			document.getElementById("temp7").innerHTML = obj.list[6].main.temp+"°C";
			document.getElementById("temp8").innerHTML = obj.list[7].main.temp+"°C";
